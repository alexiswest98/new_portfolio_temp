  ...
  const projects = [
    {
      name: "LEXFLIX",
      description:
        "Full stack clone of Netflix. Create, View, Update, and Delete profiles, movie and tv show reviews, and your 'My List'.",
      tags: [
        {
          name: "React/Redux",
